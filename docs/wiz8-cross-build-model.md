...
The already reviewed SGP mappings live as accepted identity claims in `evidence/reviewed/wiz8/claims.csv`, with
...
seed identities are tracked in `evidence/reviewed/wiz8/claims.csv`; corroborating,
