...
def test_read_slf_uses_the_eof_directory_and_low_status_byte(tmp_path: Path) -> None:
    ...
    active = struct.pack("<256sIIIQI", _fixed(b"one.bin"), SLF_HEADER_SIZE, 3, 0, 1234, 0)
    deleted = struct.pack("<256sIIIQI", _fixed(b"old.bin"), SLF_HEADER_SIZE + 3, 2, 0x101, 5678, 9)
