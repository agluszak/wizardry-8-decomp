...
def test_reviewed_wiz8_class_model_owns_layout_and_vtable_facts() -> None:
    ...
    assert len(model.vtables) == 74
    assert len(model.slots) == 185
    ...
    assert [
        ...
        (0x2F, 0x4, "runtime_stat_max_2f", "int32"),
        (0x33, 0x4, "runtime_stat_current_33", "int32"),
        (0x9F, 0x4, "value_9f", "int32"),
        (0x1E7, 0x7, "attribute_adjustments_1e7", "bytes"),
        (0x242, 0x4, "runtime_value_242", "int32"),
        (0x247, 0x5, "converted_attributes_247", "bytes"),
        (0x24D, 0x1, "flag_24d", "uint8"),
        (0x24E, 0x1, "motionless", "uint8"),
        (0x24F, 0x4, "scale_24f", "float"),
        (0x253, 0x1, "flag_253", "bytes"),
        (0x255, 0x1, "flag_255", "bytes"),
        (0x2DA, 0x4, "value_2da", "int32"),
        (0x2F1, 0x4, "runtime_value_2f1", "int32"),
        (0x2FD, 0x4, "control_state", "int32"),
    ]
