...
/* The monster-side difficulty scaler: a hostile monster scales like a
   turncoated character and a friendly one like a party character. Normal
   difficulty leaves the value alone. */
