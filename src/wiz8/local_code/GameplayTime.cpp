...
void RebuildMonsterRegenRates00502C50(W8MonsterInfo* monster_info)
{
    ...
    rate = (static_cast<float>(static_cast<unsigned int>(monster_info->hp_max)) *
            ...
            g_monster_record_float_scale) *
               0.0041666669f +
           static_cast<float>(static_cast<signed char>(monster_info->modifiers_1db.health_regen_adjustment));
    ...
    rate = (static_cast<float>(static_cast<unsigned int>(monster_info->stamina_max)) *
            ...
            g_monster_record_float_scale) *
               0.0041666669f +
           static_cast<float>(static_cast<signed char>(monster_info->modifiers_1db.stamina_regen_adjustment));
...
void GameTurnsPassedChar00503100(int party_slot, unsigned int minutes)
{
    ...
    signed char health_mod = static_cast<signed char>(character->bonus_1770.health_regen_adjustment);
    if (health_mod > 0) {
    ...
    signed char stamina_mod = static_cast<signed char>(character->bonus_1770.stamina_regen_adjustment);
    if (stamina_mod > 0) {
    ...
    for (realm = 0; realm < W8_SPELL_REALM_COUNT; ++realm) {
        signed char spell_mod = static_cast<signed char>(character->bonus_1770.spell_regen_adjustment);
        if (spell_mod > 0) {
...
after_early: {
    ...
    }
    {
        ...
        int amount = (static_cast<int>(data->hp_regeneration_17c) +
                      static_cast<int>(
                          static_cast<signed char>(monster_info->modifiers_1db.health_regen_adjustment))) *
    ...
    {
        int amount =
            (static_cast<int>(static_cast<signed char>(monster_info->modifiers_1db.stamina_regen_adjustment)) +
