...
W8Region g_regions[1500] = {
    ...
    {0x00000001, 24, 68, 42, 85, W8_UNRECOVERED_REGION_CB(0x005673B0), 0, 0, 0, -1, 0},
    {0x00000001, 595, 68, 613, 85, W8_UNRECOVERED_REGION_CB(0x005673B0), 1, 0, 0, -1, 0},

    {0x00000001, 24, 153, 42, 170, W8_UNRECOVERED_REGION_CB(0x005673B0), 2, 0, 0, -1, 0},
    {0x00000001, 595, 153, 613, 170, W8_UNRECOVERED_REGION_CB(0x005673B0), 3, 0, 0, -1, 0},
    {0x00000001, 24, 238, 42, 255, W8_UNRECOVERED_REGION_CB(0x005673B0), 4, 0, 0, -1, 0},

    {0x00000001, 595, 238, 613, 255, W8_UNRECOVERED_REGION_CB(0x005673B0), 5, 0, 0, -1, 0},
    {0x00000001, 24, 323, 42, 340, W8_UNRECOVERED_REGION_CB(0x005673B0), 6, 0, 0, -1, 0},
    {0x00000001, 595, 323, 613, 340, W8_UNRECOVERED_REGION_CB(0x005673B0), 7, 0, 0, -1, 0},

    {0x00000001, 0, 0, 0, 0, W8_UNRECOVERED_REGION_CB(0x0059BD20), 0, 1, 0, 1984, 0},
    {0x00000001, 0, 0, 0, 0, W8_UNRECOVERED_REGION_CB(0x0059BD20), 1, 1, 0, 1984, 0},
    {0x00000001, 0, 0, 0, 0, W8_UNRECOVERED_REGION_CB(0x0059BD20), 2, 1, 0, 1984, 0},

    {0x00000001, 0, 0, 0, 0, W8_UNRECOVERED_REGION_CB(0x0059BD20), 3, 1, 0, 1984, 0},
    {0x00000001, 0, 0, 0, 0, W8_UNRECOVERED_REGION_CB(0x0059BD20), 4, 1, 0, 1984, 0},
    {0x00000001, 0, 0, 0, 0, W8_UNRECOVERED_REGION_CB(0x0059BD20), 5, 1, 0, 1984, 0},

    {0x00000001, 0, 0, 0, 0, W8_UNRECOVERED_REGION_CB(0x0059BD20), 6, 1, 0, 1984, 0},
    {0x00000001, 0, 0, 0, 0, W8_UNRECOVERED_REGION_CB(0x0059BD20), 7, 1, 0, 1984, 0},
    {0x00000001, 0, 0, 0, 0, W8_UNRECOVERED_REGION_CB(0x0059C260), 0, 1, 0, 1985, 0},

    {0x00000001, 0, 0, 0, 0, W8_UNRECOVERED_REGION_CB(0x0059C260), 1, 1, 0, 1985, 0},
    {0x00000001, 0, 0, 0, 0, W8_UNRECOVERED_REGION_CB(0x0059C260), 2, 1, 0, 1985, 0},
    {0x00000001, 0, 0, 0, 0, W8_UNRECOVERED_REGION_CB(0x0059C260), 3, 1, 0, 1985, 0},

    {0x00000001, 0, 0, 0, 0, W8_UNRECOVERED_REGION_CB(0x0059C260), 4, 1, 0, 1985, 0},
    {0x00000001, 0, 0, 0, 0, W8_UNRECOVERED_REGION_CB(0x0059C260), 5, 1, 0, 1985, 0},
    {0x00000001, 0, 0, 0, 0, W8_UNRECOVERED_REGION_CB(0x0059C260), 6, 1, 0, 1985, 0},

    {0x00000001, 0, 0, 0, 0, W8_UNRECOVERED_REGION_CB(0x0059C260), 7, 1, 0, 1985, 0},
    {0x00000002, 32, 27, 8, 0, W8_UNRECOVERED_REGION_CB(0x005667A0), 0, 1, 0, 25, 0},
    {0x00000002, 95, 27, 8, 0, W8_UNRECOVERED_REGION_CB(0x00566AE0), 0, 1, 0, 26, 0},

    {0x00000001, 23, 18, 104, 89, W8_UNRECOVERED_REGION_CB(0x00565990), 0, 0, 0, -1, 0},
    {0x00000001, 21, 91, 105, 101, W8_UNRECOVERED_REGION_CB(0x0058F240), 0, 0, 0, -1, 0},
    {0x00000001, 4, 42, 19, 90, W8_UNRECOVERED_REGION_CB(0x00566E20), 0, 1, 0, 28, 0},

    {0x00000001, 109, 42, 123, 90, W8_UNRECOVERED_REGION_CB(0x005670C0), 0, 1, 0, 24, 0},
    {0x00000002, 608, 27, 8, 0, W8_UNRECOVERED_REGION_CB(0x005667A0), 1, 1, 0, 25, 0},
    {0x00000002, 544, 27, 8, 0, W8_UNRECOVERED_REGION_CB(0x00566AE0), 1, 1, 0, 26, 0},

    {0x00000001, 535, 18, 616, 89, W8_UNRECOVERED_REGION_CB(0x00565990), 1, 0, 0, -1, 0},
    {0x00000001, 539, 91, 612, 101, W8_UNRECOVERED_REGION_CB(0x0058F240), 1, 0, 0, -1, 0},
    {0x00000001, 621, 42, 635, 90, W8_UNRECOVERED_REGION_CB(0x00566E20), 1, 1, 0, 28, 0},

    {0x00000001, 517, 42, 531, 90, W8_UNRECOVERED_REGION_CB(0x005670C0), 1, 1, 0, 24, 0},
    {0x00000002, 32, 112, 8, 0, W8_UNRECOVERED_REGION_CB(0x005667A0), 2, 1, 0, 25, 0},
    {0x00000002, 95, 112, 8, 0, W8_UNRECOVERED_REGION_CB(0x00566AE0), 2, 1, 0, 26, 0},

    {0x00000001, 23, 103, 104, 174, W8_UNRECOVERED_REGION_CB(0x00565990), 2, 0, 0, -1, 0},
    {0x00000001, 21, 176, 105, 186, W8_UNRECOVERED_REGION_CB(0x0058F240), 2, 0, 0, -1, 0},
    {0x00000001, 4, 125, 19, 173, W8_UNRECOVERED_REGION_CB(0x00566E20), 2, 1, 0, 28, 0},

    {0x00000001, 109, 125, 123, 173, W8_UNRECOVERED_REGION_CB(0x005670C0), 2, 1, 0, 24, 0},
    {0x00000002, 608, 112, 8, 0, W8_UNRECOVERED_REGION_CB(0x005667A0), 3, 1, 0, 25, 0},
    {0x00000002, 544, 112, 8, 0, W8_UNRECOVERED_REGION_CB(0x00566AE0), 3, 1, 0, 26, 0},

    {0x00000001, 535, 103, 616, 174, W8_UNRECOVERED_REGION_CB(0x00565990), 3, 0, 0, -1, 0},
    {0x00000001, 539, 176, 612, 186, W8_UNRECOVERED_REGION_CB(0x0058F240), 3, 0, 0, -1, 0},
    {0x00000001, 621, 125, 635, 173, W8_UNRECOVERED_REGION_CB(0x00566E20), 3, 1, 0, 28, 0},

    {0x00000001, 517, 125, 531, 173, W8_UNRECOVERED_REGION_CB(0x005670C0), 3, 1, 0, 24, 0},
    {0x00000002, 32, 198, 8, 0, W8_UNRECOVERED_REGION_CB(0x005667A0), 4, 1, 0, 25, 0},
    {0x00000002, 95, 198, 8, 0, W8_UNRECOVERED_REGION_CB(0x00566AE0), 4, 1, 0, 26, 0},

    {0x00000001, 23, 189, 104, 255, W8_UNRECOVERED_REGION_CB(0x00565990), 4, 0, 0, -1, 0},
    {0x00000001, 21, 261, 105, 271, W8_UNRECOVERED_REGION_CB(0x0058F240), 4, 0, 0, -1, 0},
    {0x00000001, 4, 210, 19, 258, W8_UNRECOVERED_REGION_CB(0x00566E20), 4, 1, 0, 28, 0},

    {0x00000001, 109, 210, 123, 258, W8_UNRECOVERED_REGION_CB(0x005670C0), 4, 1, 0, 24, 0},
    {0x00000002, 608, 198, 8, 0, W8_UNRECOVERED_REGION_CB(0x005667A0), 5, 1, 0, 25, 0},
    {0x00000002, 544, 198, 8, 0, W8_UNRECOVERED_REGION_CB(0x00566AE0), 5, 1, 0, 26, 0},

    {0x00000001, 535, 189, 616, 255, W8_UNRECOVERED_REGION_CB(0x00565990), 5, 0, 0, -1, 0},
    {0x00000001, 539, 261, 612, 271, W8_UNRECOVERED_REGION_CB(0x0058F240), 5, 0, 0, -1, 0},
    {0x00000001, 621, 210, 635, 258, W8_UNRECOVERED_REGION_CB(0x00566E20), 5, 1, 0, 28, 0},

    {0x00000001, 517, 210, 531, 258, W8_UNRECOVERED_REGION_CB(0x005670C0), 5, 1, 0, 24, 0},
    {0x00000002, 32, 283, 8, 0, W8_UNRECOVERED_REGION_CB(0x005667A0), 6, 1, 0, 25, 0},
    {0x00000002, 95, 283, 8, 0, W8_UNRECOVERED_REGION_CB(0x00566AE0), 6, 1, 0, 26, 0},

    {0x00000001, 23, 274, 104, 344, W8_UNRECOVERED_REGION_CB(0x00565990), 6, 0, 0, -1, 0},
    {0x00000001, 21, 346, 105, 356, W8_UNRECOVERED_REGION_CB(0x0058F240), 6, 0, 0, -1, 0},
    {0x00000001, 4, 295, 19, 343, W8_UNRECOVERED_REGION_CB(0x00566E20), 6, 1, 0, 28, 0},

    {0x00000001, 109, 295, 123, 343, W8_UNRECOVERED_REGION_CB(0x005670C0), 6, 1, 0, 24, 0},
    {0x00000002, 608, 283, 8, 0, W8_UNRECOVERED_REGION_CB(0x005667A0), 7, 1, 0, 25, 0},
    {0x00000002, 544, 283, 8, 0, W8_UNRECOVERED_REGION_CB(0x00566AE0), 7, 1, 0, 26, 0},

    {0x00000001, 535, 274, 616, 344, W8_UNRECOVERED_REGION_CB(0x00565990), 7, 0, 0, -1, 0},
    {0x00000001, 539, 346, 612, 356, W8_UNRECOVERED_REGION_CB(0x0058F240), 7, 0, 0, -1, 0},
    {0x00000001, 621, 295, 635, 343, W8_UNRECOVERED_REGION_CB(0x00566E20), 7, 1, 0, 28, 0},

    {0x00000001, 517, 295, 531, 343, W8_UNRECOVERED_REGION_CB(0x005670C0), 7, 1, 0, 24, 0},
    {0x00000001, 457, 363, 472, 378, W8_UNRECOVERED_REGION_CB(0x0058E2A0), 0, 0, 0, -1, 0},
    {0x00000001, 457, 429, 472, 444, W8_UNRECOVERED_REGION_CB(0x0058E650), 0, 0, 0, -1, 0},

    {0x00000001, 461, 379, 468, 428, TextBoxScrollThumbRegionEvent, 0, 0, 0, -1, 0},
    {0x00000001, 166, 362, 456, 445, W8_UNRECOVERED_REGION_CB(0x0058ED90), 0, 0, 0, -1, 0},
    {0x00000001, 140, 362, 163, 377, W8_UNRECOVERED_REGION_CB(0x0058EFD0), 0, 1, 0, 33, 0},

    {0x00000001, 140, 383, 163, 398, W8_UNRECOVERED_REGION_CB(0x0058EFD0), 1, 1, 0, 34, 0},
    {0x00000001, 140, 404, 163, 419, W8_UNRECOVERED_REGION_CB(0x0058EFD0), 3, 1, 0, 35, 0},
    {0x00000001, 128, 358, 511, 450, W8_UNRECOVERED_REGION_CB(0x0058F240), 0, 0, 0, -1, 0},

    {0x00000001, 0, 18, 21, 102, W8_UNRECOVERED_REGION_CB(0x00565990), 0, 1, 0, -1, 0},
    {0x00000001, 617, 18, 639, 102, W8_UNRECOVERED_REGION_CB(0x00565990), 1, 1, 0, -1, 0},
    {0x00000001, 0, 103, 21, 187, W8_UNRECOVERED_REGION_CB(0x00565990), 2, 1, 0, -1, 0},

    {0x00000001, 617, 103, 639, 187, W8_UNRECOVERED_REGION_CB(0x00565990), 3, 1, 0, -1, 0},
    {0x00000001, 0, 188, 21, 272, W8_UNRECOVERED_REGION_CB(0x00565990), 4, 1, 0, -1, 0},
    {0x00000001, 617, 188, 639, 272, W8_UNRECOVERED_REGION_CB(0x00565990), 5, 1, 0, -1, 0},

    {0x00000001, 0, 273, 21, 357, W8_UNRECOVERED_REGION_CB(0x00565990), 6, 1, 0, -1, 0},
    {0x00000001, 617, 273, 639, 357, W8_UNRECOVERED_REGION_CB(0x00565990), 7, 1, 0, -1, 0},
    {0x00000002, 75, 402, 46, 0, W8_UNRECOVERED_REGION_CB(0x00567600), 0, 1, 0, 31, 0},

    {0x00000002, 564, 402, 40, 0, FormationBoardRegionEvent, 0, 1, 0, 32, 0},
    {0x00000001, 512, 358, 617, 450, W8_UNRECOVERED_REGION_CB(0x0058F240), 0, 0, 0, -1, 0},
    {0x00000001, 0, 0, 0, 0, W8_UNRECOVERED_REGION_CB(0x0056F020), 9, 0, 0, -1, 0},

    {0x00000001, 0, 0, 0, 0, W8_UNRECOVERED_REGION_CB(0x0056F020), 10, 0, 0, -1, 0},
    {0x00000001, 0, 0, 0, 0, W8_UNRECOVERED_REGION_CB(0x0056F020), 11, 0, 0, -1, 0},
    {0x00000001, 0, 0, 0, 0, W8_UNRECOVERED_REGION_CB(0x0056F020), 12, 0, 0, -1, 0},

    {0x00000001, 0, 0, 0, 0, W8_UNRECOVERED_REGION_CB(0x0056F020), 13, 0, 0, -1, 0},
    {0x00000001, 0, 0, 0, 0, W8_UNRECOVERED_REGION_CB(0x0056F020), 14, 0, 0, -1, 0},
    {0x00000001, 0, 0, 0, 0, W8_UNRECOVERED_REGION_CB(0x0056F020), 15, 0, 0, -1, 0},

    {0x00000001, 0, 0, 0, 0, W8_UNRECOVERED_REGION_CB(0x0056F020), 16, 0, 0, -1, 0},
    {0x00000001, 0, 0, 0, 0, W8_UNRECOVERED_REGION_CB(0x0056F020), 17, 0, 0, -1, 0},
    {0x00000001, 0, 0, 0, 0, W8_UNRECOVERED_REGION_CB(0x0056F020), 18, 0, 0, -1, 0},

    {0x00000001, 0, 0, 0, 0, W8_UNRECOVERED_REGION_CB(0x0056F020), 19, 0, 0, -1, 0},
    {0x00000001, 0, 0, 0, 0, W8_UNRECOVERED_REGION_CB(0x0056F020), 20, 0, 0, -1, 0},
    {0x00000001, 0, 0, 0, 0, W8_UNRECOVERED_REGION_CB(0x0056F020), 21, 0, 0, -1, 0},

    {0x00000001, 0, 0, 0, 0, W8_UNRECOVERED_REGION_CB(0x0056F020), 22, 0, 0, -1, 0},
    {0x00000001, 0, 0, 0, 0, W8_UNRECOVERED_REGION_CB(0x0056F020), 23, 0, 0, -1, 0},
    {0x00000001, 0, 0, 0, 0, W8_UNRECOVERED_REGION_CB(0x0056F020), 24, 0, 0, -1, 0},

    {0x00000001, 0, 0, 0, 0, W8_UNRECOVERED_REGION_CB(0x0056F020), 25, 0, 0, -1, 0},
    {0x00000001, 0, 0, 0, 0, W8_UNRECOVERED_REGION_CB(0x0056F020), 26, 0, 0, -1, 0},
    {0x00000001, 0, 0, 0, 0, W8_UNRECOVERED_REGION_CB(0x0056F020), 27, 0, 0, -1, 0},

    {0x00000001, 0, 0, 0, 0, W8_UNRECOVERED_REGION_CB(0x0056F020), 28, 0, 0, -1, 0},
    {0x00000001, 0, 0, 0, 0, W8_UNRECOVERED_REGION_CB(0x0056F020), 29, 0, 0, -1, 0},
    {0x00000001, 0, 0, 0, 0, W8_UNRECOVERED_REGION_CB(0x0056F020), 30, 0, 0, -1, 0},

    {0x00000001, 0, 0, 0, 0, W8_UNRECOVERED_REGION_CB(0x0056F020), 31, 0, 0, -1, 0},
    {0x00000001, 0, 0, 0, 0, W8_UNRECOVERED_REGION_CB(0x0056F020), 32, 0, 0, -1, 0},
    {0x00000001, 0, 0, 0, 0, W8_UNRECOVERED_REGION_CB(0x0056F020), 33, 0, 0, -1, 0},

    {0x00000001, 0, 0, 0, 0, W8_UNRECOVERED_REGION_CB(0x0056F020), 34, 0, 0, -1, 0},
    {0x00000001, 0, 0, 0, 0, W8_UNRECOVERED_REGION_CB(0x0056F020), 35, 0, 0, -1, 0},
    {0x00000001, 0, 0, 0, 0, W8_UNRECOVERED_REGION_CB(0x0056F020), 36, 0, 0, -1, 0},

    {0x00000001, 0, 0, 0, 0, W8_UNRECOVERED_REGION_CB(0x0056F020), 37, 0, 0, 0, 0},
    {0x00000001, 0, 0, 0, 0, W8_UNRECOVERED_REGION_CB(0x0056F020), 1, 0, 0, -1, 0},
    {0x00000001, 0, 0, 0, 0, W8_UNRECOVERED_REGION_CB(0x0056F020), 2, 0, 0, -1, 0},

    {0x00000001, 0, 0, 0, 0, W8_UNRECOVERED_REGION_CB(0x0056F020), 3, 0, 0, -1, 0},
    {0x00000001, 0, 0, 0, 0, W8_UNRECOVERED_REGION_CB(0x0056F020), 4, 0, 0, -1, 0},
    {0x00000001, 0, 0, 0, 0, W8_UNRECOVERED_REGION_CB(0x0056F020), 5, 0, 0, -1, 0},

    {0x00000001, 0, 0, 0, 0, W8_UNRECOVERED_REGION_CB(0x0056F020), 6, 0, 0, -1, 0},
    {0x00000001, 0, 0, 0, 0, W8_UNRECOVERED_REGION_CB(0x0056F020), 7, 0, 0, -1, 0},
    {0x00000001, 0, 0, 0, 0, W8_UNRECOVERED_REGION_CB(0x0056F020), 8, 0, 0, -1, 0},

    {0x00000001, 0, 0, 0, 0, W8_UNRECOVERED_REGION_CB(0x0056F020), 39, 0, 0, 0, 0},
...
#pragma clang diagnostic pop
    ...
    {0x00000001, 0, 0, 0, 0, W8_UNRECOVERED_REGION_CB(0x00568100), 0, 1, 0, 36, 0},
