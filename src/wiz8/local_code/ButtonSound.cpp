...
const char* g_button_sound_paths_62a458[4][4] = {
    {0, 0, 0, 0},
    {g_button_whoosh_62a56c, 0, g_button_click_2_62a544, g_button_click_1_62a51c},
...
char g_button_click_1_62a51c[] = "Data\\Sound\\Misc\\Interface Click 01.wav";
// GLOBAL: WIZ8 0x0062A544
char g_button_click_2_62a544[] = "Data\\Sound\\Misc\\Interface Click 02.wav";
// GLOBAL: WIZ8 0x0062A56C
char g_button_whoosh_62a56c[] = "Data\\Sound\\Misc\\Interface Whoosh 01 Soft.wav";
...
void PlayButtonSound(int sound_id)
{
    ...
    if (scheme < 0) {
        ...
        scheme = g_button_sound_scheme_stack_62a498[g_button_sound_scheme_stack_top_68de38];
    } else {
