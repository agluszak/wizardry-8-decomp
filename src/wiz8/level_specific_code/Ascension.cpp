...
/* The Footsteps shape callback (Triangle/Circle/Square/Star): on the first
   step latch DeactivatingBomb and queue the NPC-0x46 script notice. */
// FUNCTION: WIZ8 0x004E0560
bool AscensionFootstepsShape004E0560(Trigger* pTrigger)
{
...
/* The Footsteps ButtonBlocker callback: pin the blocker prop, queue the
   NPC-0x46 script notice and latch fact 0x156. */
// FUNCTION: WIZ8 0x004E05A0
bool AscensionButtonBlocker004E05A0(Trigger* pTrigger)
{
    ...
    QueueNpcScriptNotice(GetNpcStateByKind(0x46), 0, 0, 1, 0);
    SetFact(0x156, 1, 0);
    return true;
}
