/* Wizardry 8 product derivative of released SFI SGP LibraryDataBase.c.
   The record extensions and patch precedence are retained here; the pristine
   SFI-licensed oracle remains under third_party/sfi-sgp. */
