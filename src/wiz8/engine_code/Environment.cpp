...
/* 0x00659AB4: the render root; its 0x54 slot holds the sky node. */
extern unsigned char* g_render_root_00659ab4;
...
{
    unsigned char* sky = *(unsigned char**)(g_render_root_00659ab4 + 0x54);
...
{
    srNode* sky = *(srNode**)(g_render_root_00659ab4 + 0x54);
