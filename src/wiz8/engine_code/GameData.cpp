        ...
        *delta = g_level_data_00652dac->vector_a0;
        {
            ...
            if (s_diag_count < 40 && g_level_data_00652dac->vector_40.Length() > 0.001f) {
                ...
                fprintf(stderr,
                        ...
                        (unsigned)g_shared_timer_paused,
                        g_game_time_accumulator_6598bc == 0 ? 0xFFFF
                                                            : g_game_time_accumulator_6598bc->m_flags,
                        (unsigned)g_shared_timer_flag_d1, (unsigned)g_shared_timer_flag_d2,
                        (unsigned)g_flag_00652dce, (void*)g_environ_00652DB4,
...
#pragma clang diagnostic pop
    ...
    if ((flags_00 & 4) != 0) {
        ...
        } else if (g_environ_00652DB4->motion_factor_20 < slope_48) {
    ...
    }
    {
        ...
        if (s_diag_timer < 30) {
            ...
            fprintf(stderr,
                    ...
                    (unsigned)g_flag_00652dce, (unsigned)g_shared_timer_paused,
                    g_current_screen_state.id, (void*)g_game_time_accumulator_6598bc);
            fflush(stderr);
        }
    }
...
unsigned char W8LevelDataRecord::IntegrateCameraForward00420470()
{
    ...
    limit = g_environ_00652DB4->motion_limit_38 * camera_scale_14;
    if (limit <= vector_40.Length()) {
        ...
        scale = g_environ_00652DB4->momentum_scale_3c * g_environ_00652DB4->motion_factor_20;
        vector_70 *= scale;
    } else {
