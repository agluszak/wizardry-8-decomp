...
/*
 * Compiler-emitted srMath template bodies.
 *
 * The implementations live in surrender/srMath.h. These markers only record
 * the out-of-line retail emissions and their addresses.
 */
