...
/* A growable-vector family of the shape docs/libraries/wiz8-foundation-types.md
   ...
   The complete destructor stores the base table 0x005ECAA4, not the
   0x005ECAA0 the constructor installs, because its own store is dead
...
class W8Vector005ECAA0 : public W8GrowableVector<W8VectorElement005ECAA0*> {
public:
    W8Vector005ECAA0(int initial_capacity);
    virtual ~W8Vector005ECAA0() override;
};                                       /* 0x10 */

// FUNCTION: WIZ8 0x0048ce20
W8Vector005ECAA0::W8Vector005ECAA0(int initial_capacity)
    : W8GrowableVector<W8VectorElement005ECAA0*>(initial_capacity)
{
}

// FUNCTION: WIZ8 0x0048ce80
W8Vector005ECAA0::~W8Vector005ECAA0()
{
}
