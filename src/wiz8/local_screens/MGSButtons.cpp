...
/* The six sub-menu panel build/state functions below sit in the
   MGSPortraitCombat.cpp span in retail, but every one has a unique demo match
   bounded inside the demo MGSButtons.cpp hull between its source-path anchors
   0x0059DD20 and 0x0059EB10:
     0x005957E0 -> 0x0059DF10   0x00595850 -> 0x0059DF80
     0x00595EA0 -> 0x0059E5D0   0x00595FE0 -> 0x0059E710
     0x00596240 -> 0x0059E970   0x00596360 -> 0x0059EA90
   The sub-menu runtime globals they drive (0x0069B854-0x0069B8EC) are owned
   here as well. */
