...
void UpdateSubMenuButton(int index)
{
    ...
    if (gXStatus.fNpcDialogueMode != 0 &&
        (index != 0 || Function56EFB0() != 0 || CanOpenNpcDialogue() != 0)) {
    ...
    case 2:
        ...
        if (g_submenu_buttons_69b8b0[2]->IsPressed() != (g_status_685170.flag_238f != 0)) {
            g_submenu_buttons_69b8b0[2]->SetPressed(g_status_685170.flag_238f != 0);
        }
        break;
    case 3:
...
{
    Function517780();
    button->SetPressed(g_status_685170.flag_238f ? 1 : 0);
    RequestRedraw(0x200);
    DrawSubMenuCharacterAction();
}
...
int CheckSubMenuActionUsable(int party_slot)
{
...
short GetSubMenuEntryState(short menu, short item, int party_slot)
{
    short state;
