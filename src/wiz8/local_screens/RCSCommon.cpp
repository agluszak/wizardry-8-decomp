...
/* Only the members these bodies reach are declared; the full class lives with
   Local Code\Controls.cpp. */
...
/* Redraw the first panel. */
// FUNCTION: WIZ8 0x005B6590
void RedrawRcsPanelA(void)
{
    g_rcs_panel_a_0069c3c4->Redraw(0);
}
...
{
    g_rcs_panel_b_0069c3c8->Redraw(0);
}
...
/* Bring the second panel up to date. Its widget is available only in the two
   leading modes, out of combat and out of camp; enabling it also redraws the
