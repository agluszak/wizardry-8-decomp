...
void Function57D740(void)
{
    ...
    g_flag_68f105 = 1;
    Function58AA20(-1);
    Function58AAD0(6, L"What would you like to do?", 0);
    Function58AAD0(15, L"1) Create a monster.", 0);
    Function58AAD0(15, L"2) Create an item.", 0);
    Function58AAD0(15, L"3) Edit object(s).", 0);
    Function58AAD0(15, L"4) Monster Generators.", 0);
    Function58AAD0(15, L"5) Select object(s).", 0);
    Function58AAD0(15, L"6) Handle triggers.", 0);
