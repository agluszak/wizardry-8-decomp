...
void RebuildSpellIconHudRows(void)
{
    ...
    for (slot = 0; slot < 12; ++slot) {
        ...
        if (effect->active != 0) {
            ...
            g_spell_icon_count = g_spell_icon_count + 1;
            right = left - 1;
            left = left - 0x13;
        }
    }
...
void RebuildCombatEffectHudRows(void)
{
    ...
    for (slot = 0; slot < 9; ++slot) {
        ...
        if (effect->active != 0) {
            ...
            g_combat_effect_left_count = g_combat_effect_left_count + 1;
            left = right + 1;
            right = right + 0x15;
        }
    }
    ...
    for (slot = 0; slot < 6; ++slot) {
        ...
        if (effect->active != 0) {
            ...
            g_combat_effect_right_count = g_combat_effect_right_count + 1;
            right = left - 1;
            left = left - 0x15;
        }
    }
