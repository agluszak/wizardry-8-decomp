...
/* Retail places this pair in the MainGameScreen.cpp span, but the demo bounds
   their matches (0x0059AA50 sim 0.875, 0x0059AA90 unique) inside the
   MGSKeyboard.cpp hull anchored at 0x005988E0/0x0059AE40. */
