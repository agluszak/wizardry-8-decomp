    ...
    apply_enrichment: Annotated[
        ...
        typer.Option(
            ...
            help=(
                ...
                "restored project under build/enrichment-checkpoint/ unless --live. "
                "Promote accepted candidates with `wiz8 analyze enrichment-promote`."
            ),
        ),
    ] = False,
    ...
    live: Annotated[
        ...
        typer.Option(
            ...
            help=(
                ...
                "instead of a disposable restore under build/enrichment-checkpoint/. "
...
def enrichment_promote_command(
    ...
    from_latest: Annotated[
        ...
        typer.Option(
            "--from-latest",
            help=(
                "Promote the newest build/enrichment-checkpoint/run-* whose report "
