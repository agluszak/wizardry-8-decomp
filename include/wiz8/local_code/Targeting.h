...
unsigned char ShouldClearAimForAppliedTarget( // bool-byte-ok: retail returns al as unsigned char
    W8TargetSource* source, W8CombatSlot* target, W8TargetingContext context,
