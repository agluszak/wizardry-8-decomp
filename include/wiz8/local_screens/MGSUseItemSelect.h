...
void OpenUseItemAssayDialog(W8ItemInstance* item);   /* 0x0059D880 */
void RestoreTargetCursor(W8DialogBase* dialog);      /* 0x0059D930 */
void UpdateUseItemDetailPanel(W8ItemInstance* item); /* 0x0059DFA0 */
void TakeUseItemIntoHand(void);                      /* 0x0059E0F0 */
