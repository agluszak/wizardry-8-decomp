...
/* 0x0058AAD0: the banner-style notice several hundred callers post; it sits in
   the unanchored range before this unit's anchors. */
void Function58AAD0(int icon, const wchar_t* title, const wchar_t* name, const wchar_t* text);
