...
public:
    enum e_preset { PRESET_POSITIONAL_0 = 0, PRESET_POSITIONAL_1 = 1 };
...
public:
    ...
    /* stLight::process temporarily scales this renderer-owned intensity. */
    float intensity_1d0;    /* complete +0x1d0 */
